...
public class LotteryTicketSearchArray {
    ...
    public static int[] generateNumbers(){
        ...
        for(int i = 0; i < LENGTH; i++){
            ...
            //The random number generated is unique if we get here. Add it to the array.
     ...
     * @return return True if found, and return False if not
     */
    ...
    public static boolean binarySearch(int[] array, int numberToSearchFor){
        ...
        //Array must be sorted first (in ascending order)
        Arrays.sort(array);
